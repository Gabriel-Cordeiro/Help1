    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav navbar-right">
                <li> <a href= <?= base_url() . 'index.php/HomeController/sobre' ?>></a></li>
...
<div class="container-fluid containerTwo" id="page">
    ...
    <div class="info col-md-6 col-sm-12">
        ...
        <div class="row">
            <div class="col-md-12">
                <span> <h3>Quem somos nós?</h3><br>

   <p> O Help1 surge como uma proposta de desenvolvimento, voltada a tecnologia aplicada á educação. <br>Num mundo cada vez mais conectado, nós incentivamos a cooperação entre as pessoas, nós acreditamos em um sistema de educação onde todos possam aprender alguma coisa e todos possam ensinar algo.<br><br>
    ...
    <div class="row">
        ...
        <div class="col-md-4 col-sm-4 col-xs-4 menu-footer">
            ...
            <ul>
                ...
                <a href= <?= base_url() . 'index.php/HomeController/sobre' ?>>
                    <li>
                        Sobre nós
                    </li>
                </a>
